            ...
            <div className="contacts__map-container">
                ...
                <div className="contacts__map-address">
                    <h3 className="contacts__map-address-header">
                        <FormattedMessage id="headerMenuContacts" defaultMessage="Наши контакты" />
                    ...
                    <div className='footer__contacts contacts__map_text'>
                        ...
                        <p className='footer__contacts-address contacts__map_text-modifier'>
                            ООО "MIDDLE EAST POWER SOLUTIONS"
                            <FormattedMessage id="aboutusContactsAdress" defaultMessage=" 100015, Республика Узбекистан, г.Ташкент Мирабадский район, ул.Шахрисабзская 22" />
