        ...
        <div className={`popup-wrap ${props.isOpenBoiler ? 'popup-wrap_visible' : ''}`} onClick={closeByClickOnOverlay}>
            <div className={`popup ${props.isOpenBoiler ? 'popup_visible' : ''}`}>
                ...
                <p className="popup__text">
                    Водогрейные котельные предназначены для обеспечения надежного теплоснабжения промышленных объектов и удаленных потребителей.В состав поставки входят модульное здание котельной, газовый котел, водоподготовительная установка для подготовки подпиточной воды и дымовая труба.
                </p>
                <p className="popup__text">
                    Водогрейные котельные поставляются с максимальной готовностью оборудования для проведения пуско-наладочных работ и монтируются на специально подготовленный фундамент.
                </p>
                    ...
                    <div className="popup__tech-cards-container">
                        <div className="popup__tech-card">
                            ...
                            <p className="popup__tech-card-text">
                                Единичная мощность котла, до 10 Гкал/ч
                            </p>
                        </div>
                        <div className="popup__tech-card">
